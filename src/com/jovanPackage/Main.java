...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Datum> irisTest = new ArrayList<>();

        //adding dataset for learning
        ...
        irisTest.add(new Datum(5.0,3.5,1.3,0.3,0));
        irisTest.add(new Datum(4.5,2.3,1.3,0.3,0));
        irisTest.add(new Datum(4.4,3.2,1.3,0.2,0));
        irisTest.add(new Datum(5.0,3.5,1.6,0.6,0));
        irisTest.add(new Datum(5.1,3.8,1.9,0.4,0));
        irisTest.add(new Datum(4.8,3.0,1.4,0.3,0));
        irisTest.add(new Datum(5.1,3.8,1.6,0.2,0));
        irisTest.add(new Datum(4.6,3.2,1.4,0.2,0));
        irisTest.add(new Datum(5.3,3.7,1.5,0.2,0));
        irisTest.add(new Datum(5.0,3.3,1.4,0.2,0));
        irisTest.add(new Datum(5.5,2.6,4.4,1.2,1));
        irisTest.add(new Datum(6.1,3.0,4.6,1.4,1));
        irisTest.add(new Datum(5.8,2.6,4.0,1.2,1));
        irisTest.add(new Datum(5.0,2.3,3.3,1.0,1));
        irisTest.add(new Datum(5.6,2.7,4.2,1.3,1));
        irisTest.add(new Datum(5.7,3.0,4.2,1.2,1));
        irisTest.add(new Datum(5.7,2.9,4.2,1.3,1));
        irisTest.add(new Datum(6.2,2.9,4.3,1.3,1));
        irisTest.add(new Datum(5.1,2.5,3.0,1.1,1));
        irisTest.add(new Datum(5.7,2.8,4.1,1.3,1));

        stochasticGradientDescent(iris,irisTest);
    }



    public static void stochasticGradientDescent(ArrayList<Datum> array, ArrayList<Datum> validate) {
        double teta1        = 0.1;
        double teta2        = 0.2;
        double teta3        = 0.3;
        double teta4        = 0.4;
        ...
        for(int j=0; j<60; j++) {
            ...
            for(int k=0; k<validate.size(); k++){
                h = (teta1 * validate.get(k).getX1())
                        + (teta2 * validate.get(k).getX2())
                        + (teta3 * validate.get(k).getX3())
                        + (teta4 * validate.get(k).getX4())
                        + bias
                ;
            ...
            // Ini untuk print error saat testing
             System.out.println("Testing: " + df.format(error));
